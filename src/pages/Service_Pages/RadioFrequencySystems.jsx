...
function RadioFrequencySystems() {
    return (
        <div>
            ...
            <ServiceContent parag1={'Our software tools are regularly updated with new technology releases and base planning data to ensure accuracy and integrity of designs. Kordia also owns its own propagation measurement systems for most of the significant wireless bands so we can ensure the best possible prediction accuracy for all our wireless designs, and help minimise potential prediction errors. Our team can help you with:'} 
