...
function InBuildingSystems() {
    return (
        <div>
            ...
            <ServiceContent parag1={'With experience working on both greenfield and brownfield sites, the Buffalo Innovation team has worked across some of the most complex DAS projects within Australia. Due to the unique nature of each venue, no single, cookie cutter system can be constructed, making DAS a complex system to implement. Buffalo Innovation have managed projects of all sizes and with this experience, we have a high-calibre of technical professionals to support your project with the design, install and maintenance for middle-rise commercial, high-rise apartments, hospitals, stadiums, shopping centres, Universities and Government buildings. Our team will work with you through every step of the process, starting with the initial site RF assessment, final design and permit stages, to the installation of the system and ongoing support and maintenance. Buffalo Innovation services include:'} 
            ...
            <ServiceContent parag1={'As demand for wireless voice and data services increases, so does the need for robust and reliable mobile coverage. Buffalo Innovation s Wireless Coverage Solutions Group can help you achieve coverage in the most challenging environments from corporate offices to busy airport terminals and underground work sites and tunnels. We have experience with:'} 
